...
import '../viewmodels/profile_viewmodel.dart' show ProfileViewModel, EmergencyContact;
...
class ProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final profile = viewModel.getUserProfile(context);
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildEmergencyContactsSection(context, viewModel),
            const SizedBox(height: 24),
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            // Edit profile button
            ElevatedButton.icon(
              onPressed: () => _editProfile(context, viewModel, profile),
  ...
  Widget _buildEmergencyContactsSection(BuildContext context, ProfileViewModel viewModel) {
    return Card(
      elevation: 2,
      child: Padding(
        padding: const EdgeInsets.all(16),
          ...
          children: [
            Row(
              ...
              children: [
                ...
                TextButton.icon(
                  onPressed: () => _addEmergencyContact(context, viewModel),
            ...
            ...viewModel.emergencyContacts.map((contact) => _buildContactCard(context, viewModel, contact)),
          ],
        ),
      ),
    );
  ...
  Widget _buildContactCard(BuildContext context, ProfileViewModel viewModel, EmergencyContact contact) {
    return Card(
      ...
      child: ListTile(
        ...
        trailing: Row(
          ...
          children: [
            ...
            IconButton(
              onPressed: () => _editEmergencyContact(context, viewModel, contact),
  ...
  void _editProfile(BuildContext context, ProfileViewModel viewModel, UserProfile? profile) {
    final baseProfile =
        profile ??
        UserProfile(
          name: '',
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              viewModel.saveProfile(context, updatedProfile);
              _showSuccessMessage(context, 'Profile updated successfully!');
            },
  ...
  void _addEmergencyContact(BuildContext context, ProfileViewModel viewModel) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.pop(context);
              // TODO: Extract form data and add contact via ViewModel
              _showSuccessMessage(context, 'Emergency contact added!');
            },
  ...
  void _editEmergencyContact(BuildContext context, ProfileViewModel viewModel, EmergencyContact contact) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.pop(context);
              // TODO: Extract form data and update contact via ViewModel
              _showSuccessMessage(context, 'Emergency contact updated!');
            },
            child: const Text('Save'),
          ),
        ],
